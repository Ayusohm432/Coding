...
class Solution {
public:
    void makeGraph(TreeNode* root , TreeNode* previousNode , unordered_map<TreeNode* , vector<TreeNode*>>& adj , unordered_set<TreeNode*>& st){
        if(root == nullptr){
            return;
        }
        ...
        if(previousNode != nullptr){
            adj[root].push_back(previousNode);
            adj[previousNode].push_back(root);
        }
