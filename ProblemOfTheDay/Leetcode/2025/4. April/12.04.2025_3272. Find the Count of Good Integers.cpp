/*
Problem Link: https://leetcode.com/problems/find-the-count-of-good-integers?envType=daily-question&envId=2025-04-12
*/
        ...
        long long countGoodIntegers(int n, int k) {
            ...
            for(int num=start; num<=end; num++){
                ...
                if(n % 2 == 0){
                    ...
                    string rightHalf = leftHalf.substr(0, digits-1);
                    reverse(rightHalf.begin(), rightHalf.end());
                    full = leftHalf + rightHalf;
                }
