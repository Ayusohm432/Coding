/*
Problem Link: https://leetcode.com/problems/sum-of-k-mirror-numbers?envType=daily-question&envId=2025-06-23
*/
        ...
        while(n > 0){
            ...
            for(int num=minNum; num<=maxNum; num++){
                ...
                if(len % 2 == 0){
                    ...
                    palindrome = firstHalf + secondHalf.substr(1);
                }

                long long palindromeNum = stoll(palindrome);
                string baseK = convertToBaseK(palindromeNum, k);
