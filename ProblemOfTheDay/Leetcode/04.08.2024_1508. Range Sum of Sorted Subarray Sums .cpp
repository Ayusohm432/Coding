/*
Problem Link :- https://leetcode.com/problems/range-sum-of-sorted-subarray-sums/?envType=daily-question&envId=2024-08-04
*/
...
public:
    ...
    for (int i = left - 1; i < right; ++i) {
        range_sum = (range_sum + subarray_sums[i]) % MOD;
    }
